 ...
 * Use the {@link HomeCollectFragment#newInstance} factory method to
...
public class HomeCollectFragment extends Fragment {
    ...
    private HasFocusBean myHasCollectBean;
    ...
    public static HomeCollectFragment newInstance(long myUserId,String myUserName) {
        HomeCollectFragment fragment = new HomeCollectFragment();
    ...
    private void loadData() {
        MyRequest.getCollectInfo(0, 30, myUserId, new GetFocusBeanCallback() {
            @Override
            public void onSuccess(HasFocusBean hasFocusBean) {
                myHasCollectBean = hasFocusBean;
